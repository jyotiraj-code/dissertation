...
class MeanVarianceOptimization:
    def __init__(self, stocks, start_date, end_date, data_dir="C:\\Users\\jrnat\\Documents\\GitHub\\dissertation-new\\dissertation\\Paper Reading\\Paper 1 Modifications"):
        self.stocks = stocks
